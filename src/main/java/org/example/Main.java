...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            ServerDetails serverDetails = config.getServer();

            InetAddress address = InetAddress.getByName(serverDetails.getAddress());
            server = new Server();
            server.setHostNumber(serverDetails.getHostNumber());
            server.setMessageSize(2048);
            server.start(address, serverDetails.getPort(), serverDetails.getTimeout());
            ...
            SwingUtilities.invokeLater(() -> {
                ...
                startButton.addActionListener(e -> {
                    ...
                    try {
                        ...
                        server.start(serverAddress, serverDetails.getPort(), serverDetails.getTimeout());
